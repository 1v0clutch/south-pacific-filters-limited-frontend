      ...
      <div className="container-fd mx-auto px-8 lg:px-16 py-12">
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-6 lg:gap-8">
          ...
          <div>
            ...
            <ul className="list-none m-0 mt-4.5 p-0 flex flex-col gap-3">
              <li>
                <a className="inline-flex items-center gap-3 min-h-11 text-[14px] leading-5 text-(--color-text-muted-on-dark) no-underline transition-colors duration-150 hover:text-(--color-text-on-dark) cursor-pointer font-['Inter',sans-serif]">
