...
const filterMediaProducts = [
  {
    id: 'synthetic-media',
    title: 'Synthetic Media',
    description: 'High-performance synthetic filter media offering superior dust holding capacity and consistent efficiency across all humidity levels.',
    efficiency: 'F5 - F9',
    applications: ['HVAC systems', 'General ventilation', 'Industrial filtration'],
    icon: (
  ...
  },
  {
    id: 'glass-fiber',
    title: 'Glass Fiber',
    description: 'Premium glass fiber media for HEPA and ULPA applications, providing exceptional particle capture efficiency and low pressure drop.',
    efficiency: 'H10 - U17',
    applications: ['Clean rooms', 'Hospitals', 'Pharmaceutical', 'Electronics'],
    icon: (
      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: 'Highly porous activated carbon media for molecular filtration, odor control, and removal of gases and volatile organic compounds.',
    efficiency: 'Molecular',
    applications: ['Odor control', 'VOC removal', 'Chemical filtration', 'Food processing'],
    icon: (
      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: 'Versatile nonwoven filter media with excellent mechanical strength and uniform pore structure for consistent filtration performance.',
    efficiency: 'G3 - F7',
    applications: ['Pre-filtration', 'Paint booths', 'Automotive', 'General industry'],
    icon: (
      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export default function FilterMediaCategory() {
  return (
    <Layout>
      {/* Hero Section */}
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 max-w-2xl text-base leading-relaxed text-slate-300 sm:text-lg">
              Advanced filter media solutions engineered for optimal filtration performance. From synthetic materials to specialized carbon media for gas-phase filtration.
            </p>
            <div className="mt-8">
              <a
                href="/#contact"
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <div className="mb-12 text-center">
            ...
            <p className="mt-3 text-base text-slate-600">
              Browse our complete range of filter media products
            </p>
          </div>

          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-2">
            {filterMediaProducts.map((product) => (
              <Link
                key={product.id}
                to={`/products/variants/${product.id}`}
                className="group relative flex flex-col rounded-2xl border border-slate-200 bg-white p-6 transition duration-300 hover:-translate-y-1 hover:border-emerald-300/60 hover:shadow-xl hover:shadow-emerald-900/5 sm:p-8"
              >
        ...
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-14 lg:px-8">
          <div className="rounded-2xl border border-slate-200 bg-[#f0fdf4] px-6 py-10 text-center sm:px-10">
            <h2 className="font-display text-2xl font-bold text-slate-900 sm:text-3xl">
              Custom media requirements?
            </h2>
            <p className="mx-auto mt-3 max-w-2xl text-slate-600">
              We can provide custom filter media solutions tailored to your specific application requirements and performance criteria.
            </p>
